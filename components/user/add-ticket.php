    ...
    <div class="bg-white shadow-xl rounded-xl p-8 w-full max-w-xl mx-auto">
      ...
      <form id="ticket-form" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
          ...
          <input type="file" name="attachments" id="attachments" accept="application/pdf,image/jpeg,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" required class="border border-gray-300 rounded-md px-4 py-2 mt-1 w-4/5 max-w-md">
        </div>
